...
public class Path : MonoBehaviour {
    ...
    public float GetParam(Vector3 position, float lastParam) {
        ...
        Vector3 segmaentDirection = currentSegment.b - currentSegment.a;
        segmaentDirection.Normalize();

        Vector3 pointInSegment = Vector3.Project(currPos, segmaentDirection);
